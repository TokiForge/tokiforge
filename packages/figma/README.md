...
Figma integration for TokiForge design tokens (v1.0.0). Sync tokens between Figma and your codebase.

## Installation

```bash
npm install @tokiforge/figma@^1.0.0 @tokiforge/core@^1.0.0
```
