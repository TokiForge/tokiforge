...
Monorepo version alignment: all publishable packages and docs set to **2.0.2**; workspace dependency ranges and install examples updated. See [CHANGELOG.md](CHANGELOG.md) for details.
